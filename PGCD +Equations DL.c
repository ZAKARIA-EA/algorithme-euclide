...
int main() {
    ...
    /*Ce programme utilise l’algorithme d’Euclide étendu pour calculer le PGCD de deux entiers a et b, ainsi que les coefficients de Bézout associés.
Ensuite, il détermine s’il existe des solutions entières à l’équation diophantienne a·x + b·y = c.
En cas d’existence, il affiche une solution particulière et la forme générale*/
